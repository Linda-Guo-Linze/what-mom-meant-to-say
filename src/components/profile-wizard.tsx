...
export function ProfileWizard({ onClose, onSaved }: { onClose: () => void; onSaved: (profile: LocalProfile) => void }) {
  ...
  async function finish() {
    ...
    const profile: LocalProfile = { ...draft, profileId: makeId("profile"), voiceName: "", speechRate: 0.92, speechPitch: 1, createdAt: now, updatedAt: now };
